...
const perks = [
  {
    ...
    description:
      'Get your digital product delivered instantly and download them right away.',
  },
  {
    name: 'Guarantied Quality',
    icon: CheckCircle,
    description:
      'We only work with the best creators to ensure the highest quality of products.',
  },
  {
    name: 'For the Planet',
    icon: Leaf,
    description:
      'We are committed to planting a tree for every product sold on our platform.',
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-4 text-lg max-w-prose text-muted-foreground">
            ...
            and captivating digital art – your one-stop destination for all
            things digital excellence.
          </p>
